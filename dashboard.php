...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $req = $bdd->prepare("INSERT INTO produits (nom_produit, description) VALUES (?, ?)");
    $req->execute([$_POST['nom_produit'], $_POST['description']]);
...
<head>
    ...
    <style>
        ...
        .champ-saisie, .zone-description { width: 100%; height: 40px; background-color: #ddd; border: none; border-radius: 15px; padding: 12px; margin-bottom: 25px; box-sizing: border-box; }
        .zone-description { height: 100px; }
